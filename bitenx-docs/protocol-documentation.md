...
This document describes the protocol extensions for all additional functionality build into the BitenX protocol. This doesn't include any of the Bitcoin protocol, which has been left intact in the BitenX project. For more information about the core protocol, please see https://en.bitcoin.it/w/index.php?title#Protocol_documentation&action#edit
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | CTxIn | The unspent output which is holding 100000 BTENX
| # | addr | CService | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | CPubKey | CPubKey of the main 100000 BTENX unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 bitenx)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the bitenx treasury)
