...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitenXNetwork") type = BitenXNetwork;
    if(strType == "BitenXNetworkVariable") type = BitenXNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitenXNetwork) s = "BitenXNetwork";
    if(type == BitenXNetworkVariable) s = "BitenXNetworkVariable";
