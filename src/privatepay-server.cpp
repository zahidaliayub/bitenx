...
/*
    ...
    allow endless transaction that would bloat BitenX and make it unusable. To
    stop these kinds of attacks 1 in 10 successful transactions are charged. This
    adds up to a cost of 0.001 BTENX per transaction on average.
*/
