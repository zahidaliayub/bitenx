    ...
    mapper(0)
{
    ...
    /* Theme selector */
    //ui->theme->addItem(QString("BTENX-light"), QVariant("light"));
    ui->theme->addItem(QString("BTENX-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("BTENX-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("BTENX-traditional"), QVariant("trad"));
