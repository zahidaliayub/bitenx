    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitenX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitenX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitenx: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BitenX Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitenX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitenX Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitenX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitenX addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitenx: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitenX Core help message to get a list with possible BitenX Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitenX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitenX network", "", count));
}
...
{
    QString strTitle = tr("BitenX Core"); // default title
