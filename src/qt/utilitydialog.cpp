    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitenX Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitenX Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitenx-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitenX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BTENX, 0.1 BTENX, 1 BTENX and 10 BTENX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bitenxpay.atlassian.net/wiki/display/DOC/PrivatePay\">https://bitenxpay.atlassian.net/wiki/display/DOC/PrivatePay</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitenX Core is shutting down...") + "<br /><br />" +
