...
Only requiring some minor changes is bitenx.cpp.
...
Changes to bitenx.cpp
----------------------
bitenx.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
