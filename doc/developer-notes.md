...
BitenX Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as BitenX Core, where everyone uses
...
pay attention to for reviewers of BitenX Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BitenX Core uses tinyformat, which is type safe. Leave them out to avoid confusion
