BitenX Core version 0.12.1 is now available from:

  <https://www.bitenx.org/downloads/>
...
BitenX was previously known as Darkcoin.
...
BitenX Core tree 0.11.x was a fork of Bitcoin Core tree 0.9, Darkcoin was rebranded
to Dash.

BitenX Core tree 0.12.0.x was a fork of Bitcoin Core tree 0.10.
