...
This mechanism has been integrated into Bitcore-Node-BitenX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitenxpay/insight-api-bitenx#web-socket-api](https://github.com/bitenxpay/insight-api-bitenx#web-socket-api) 
* API: [https://github.com/bitenxpay/insight-api-bitenx#instantsend-transactions](https://github.com/bitenxpay/insight-api-bitenx#instantsend-transactions) 
...
By default, the BitenX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitenX Core daemon:
